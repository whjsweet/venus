...
export function create(hooksAndOpts = {}, createOpts = {}) {
  ...
  const app = {
    _models: [prefixNamespace({ ...reduxSagaModel })],
    _store: null,
    _plugin: plugin,
  ...
  function unmodel(createReducer, reducers, unlisteners, namespace) {
    ...
    store.replaceReducer(createReducer());
    store.dispatch({ type: '@@reduxaga/UPDATE' });
   ...
   * Attention:
   * - Only available after reduxaga.start gets called
